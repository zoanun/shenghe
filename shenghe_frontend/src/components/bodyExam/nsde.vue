          ...
          >
            ...
            >
              <template slot-scope="scope">
                ...
                <p v-else
                   @click="cellClick(scope.row, 'f_staDate')"
                >
                  {{ scope.row.staDate }}
                </p>
              </template>
            ...
            >
              <template slot-scope="scope">
                ...
                <p v-else
                   @click="cellClick(scope.row, 'f_endDate')"
                >
                  {{ scope.row.endDate }}
                </p>
              </template>
            ...
            >
              <template slot-scope="scope">
                ...
                ></el-input>
                <p v-else
                   @click="cellClick(scope.row, 'f_age')"
                >
                  {{ scope.row.age }}
                </p>
              </template>
            ...
            <el-table-column label="性别">
              <template slot-scope="scope">
                <el-link type="primary"
                         @click="toggleSex(scope.$index, scope.row)"
                >
            ...
            >
              <template slot-scope="scope">
                ...
                ></el-input>
                <p v-else
                   @click="cellClick(scope.row, 'f_value')"
                >
                  {{ scope.row.value }}
                </p>
              </template>
